...
public class KeohaneLinkedListTest {
    private CircularSinglyLinkedList<String> stringList;
    private CircularSinglyLinkedList<Integer> intList;
    ...
    @Before
    public void setUp() {
        stringList = new CircularSinglyLinkedList<String>();
        intList = new CircularSinglyLinkedList<Integer>();
    }
    ...
    public void testInitialList() {
        ...
        CircularSinglyLinkedList<Integer> intlist2 = intList;
    ...
    public void testAddAtIndex() {
        ...
        CircularSinglyLinkedListNode<String> expected = new CircularSinglyLinkedListNode<String>("A");
        ...
        // check each node
        CircularSinglyLinkedListNode<String> myNode = stringList.getHead();
    ...
    public void zResults() {
        ...
        if (testsPassed == 12 && exceptionsFailed == 0) {
            ...
            System.out.println("     You failed " + (12 - testsPassed) + " test(s) and " + exceptionsFailed
                    + " exception(s)");
        }
